...
//
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(1380.f, windowHeight * 0.6), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(1600.f, windowHeight * 0.6), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//
//
//	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1850.f, windowHeight * 0.65), CP_Vector_Set(400.f, 90.f), PLATFORM_COLOR);
//
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(1840.f, windowHeight * 0.6), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(2200.f, windowHeight * 0.6), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//
//
//
...
//	//CreateEnemy(700.f, 300.f);
//
//	CreateEnemy(1850.f, windowHeight * 0.4f);
//	CreateDummy(850.f, windowHeight * 0.7f);
//	//                           button                      door
//	CreateButtonDoorLink(CP_Vector_Set(550.f, windowHeight * 0.875), CP_Vector_Set(900, windowHeight * 0.59));
//
//
//	// Platforms
//
...
//	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1200.f, windowHeight * 0.6), CP_Vector_Set(300, windowHeight * 0.6), PLATFORM_COLOR);
//
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(1790.f, windowHeight * 0.45), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1800.f, windowHeight * 0.5), CP_Vector_Set(300.f, 100.f), PLATFORM_COLOR);
//	CreateGameElement(TRUE, Type_Obstacle, CP_Vector_Set(2105.f, windowHeight * 0.45), CP_Vector_Set(10.f, 10.f), OBSTACLE_COLOR);
//
