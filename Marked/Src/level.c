...
void Level2_Init() {
	...
	//                           button                      door
	CreateButtonDoorLink(CP_Vector_Set(550.f, windowHeight * 0.875), CP_Vector_Set(1050, windowHeight * 0.59));
...
void Level3_Init() {
	...
	CreateEnemy(750.f, windowHeight * 0.1);
	...
	CreateButtonDoorLink(CP_Vector_Set(2045.f, windowHeight * 0.275), CP_Vector_Set(3050, windowHeight * 0.13));
	//CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1050.f, 0.f), CP_Vector_Set(50, windowHeight * 0.6), PLATFORM_COLOR);
	...
	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1700.f, windowHeight * 0.2), CP_Vector_Set(200, 100), PLATFORM_COLOR);
	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(1900.f, windowHeight * 0.3), CP_Vector_Set(300, 100), PLATFORM_COLOR);
	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(2200.f, windowHeight * 0.2), CP_Vector_Set(200, 100), PLATFORM_COLOR);

	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(2200.f, windowHeight * 0.5), CP_Vector_Set(50, windowHeight * 0.9), PLATFORM_COLOR);

	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(2750.f, windowHeight * 0.2), CP_Vector_Set(300, 100), PLATFORM_COLOR);

	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(3000.f, windowHeight * 0.5), CP_Vector_Set(200, 100), PLATFORM_COLOR);
	...
	// AFTER END 
	CreateGameElement(TRUE, Type_Platform, CP_Vector_Set(4000.f, 0.f), CP_Vector_Set(1000, windowHeight), PLATFORM_COLOR);
